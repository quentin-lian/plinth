...
- import 顺序由 `@repo/prettier-config` 里的 `@ianvs/prettier-plugin-sort-imports` 负责，ESLint 不再开 `import/order`

## 依赖

```bash
pnpm add -D eslint typescript @repo/eslint-config@workspace:*
```
